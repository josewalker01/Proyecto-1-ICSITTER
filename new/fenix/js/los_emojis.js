...
(function(c) {
	...
	c.fn.emojiInit = function(b) {
		...
		if (void 0 == b || 0 >= b.length) option.error(null, "target object is undefined");
			...
			b.after("<i id='faceEnter' onclick='showFaceBlock()' style='padding: 5px;position: absolute;left:-20px;top: 190px;cursor: pointer;font: normal normal normal 25px/1 FontAwesome;'>😃</i>");
			b.after("<div id='faceBlock' style='background:rgb(216, 216, 216);border-radius: 12px;display: none;position: absolute;left: 250px solid #e2e2e2;padding: 5px;top: 50px;width: 200px;'>" + a + "</div>");
